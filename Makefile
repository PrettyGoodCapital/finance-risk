...
lint-py:  ## run python linter with ruff
	python -m ruff check finance_risk
	python -m ruff format --check finance_risk
...
fix-py:  ## fix python formatting with ruff
	python -m ruff check --fix finance_risk
	python -m ruff format finance_risk
...
test-py:  ## run python tests
	python -m pytest -v finance_risk/tests

# alias
tests-py: test-py

coverage-py:  ## run python tests and collect test coverage
	python -m pytest -v finance_risk/tests --cov=finance_risk --cov-report term-missing --cov-report xml
